...
test('short capture', function (t) {
    t.same(
        optimist.parse([ '-h', '157.230.223.107' ]),
        { h : '157.230.223.107', _ : [], $0 : $0 }
    );
    t.end();
});
...
test('short captures', function (t) {
    t.same(
        optimist.parse([ '-h', '157.230.223.107', '-p', '555' ]),
        { h : '157.230.223.107', p : 555, _ : [], $0 : $0 }
    );
    t.end();
});
...
test('long captures sp', function (t) {
    t.same(
        optimist.parse([ '--host', '157.230.223.107', '--port', '555' ]),
        { host : '157.230.223.107', port : 555, _ : [], $0 : $0 }
    );
    t.end();
});
...
test('mixed short bool and capture', function (t) {
    t.same(
        optimist.parse([ '-h', '157.230.223.107', '-fp', '555', 'script.js' ]),
        {
            f : true, p : 555, h : '157.230.223.107',
            _ : [ 'script.js' ], $0 : $0,
        }
    );
    t.end();
